        ...
        <main className="min-h-screen bg-[#050505] text-white overflow-x-hidden">
            <div className="max-w-7xl mx-auto px-6 pt-32 pb-20 animate-pulse">
                ...
                <div className="flex flex-col md:flex-row gap-4 items-center justify-between mb-8">
                    <div className="w-full md:w-64 h-12 bg-zinc-900 border border-white/10 rounded-xl"></div>
                    <div className="flex gap-2">
                        <div className="w-32 h-10 bg-zinc-900 border border-white/10 rounded-lg"></div>
                        <div className="w-10 h-10 bg-zinc-900 border border-white/10 rounded-lg"></div>
                    </div>
                </div>
