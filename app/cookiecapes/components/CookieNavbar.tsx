      ...
      <div className="bg-[#1e1e1e]/80 backdrop-blur-[10px] border border-white/10 rounded-[18px] px-2.5 h-full flex items-center justify-between shadow-[0_2px_15px_rgba(0,0,0,0.3)]">
        ...
        <div className="flex items-center">
          <a href="../"><img src="/minilogo.png" alt="CookieTeam Logo" className="h-8 w-auto object-contain transition-transform duration-300 hover:scale-[1.07]"/></a>
            <Link href="/cookiecapes" className="flex items-center gap-3 pl-2.5 group">
        ...
        <div className="flex items-center gap-3.75">
            <div id="player-count-container" className="relative group cursor-help flex items-center gap-2 bg-white/10 px-3 py-2 rounded-[12px] transition-all hover:bg-white/15">
                ...
                <div id="player-count-tooltip" className="absolute top-[calc(100%+10px)] left-1/2 -translate-x-1/2 min-w-47.5 p-[12px_18px] flex flex-col gap-2 bg-[#0c0c0c] border border-white/10 rounded-[10px] shadow-[0_4px_15px_rgba(0,0,0,0.3)] opacity-0 invisible group-hover:opacity-100 group-hover:visible group-hover:top-[calc(100%+12px)] transition-all duration-300 z-10">
                    ...
                    <div className="flex items-center gap-2.5 text-[#4ade80] text-sm font-medium">
                        <svg className="w-4.5 h-4.5 fill-[#4ade80]" viewBox="0 0 24 24">
                            <path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z"></path>
                        </svg>
